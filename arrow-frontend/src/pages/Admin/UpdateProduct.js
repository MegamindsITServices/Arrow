...
const UpdateProduct = () => {
  ...
  const getSingleProduct = async () => {
    try {
      const { data } = await axios.get(
        `https://api.arrowpublications.in/api/v1/product/get-product/${uid}`
      );
      ...
      setshippingPrice(data.product?.shippingPrice);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  //   try {
  //     const { data } = await axios.get("https://api.arrowpublications.in/api/v1/category/categories");
  //     if (data?.success) {
  ...
  //   try {
  //     const { data } = await axios.get("https://api.arrowpublications.in/api/v1/subject/subjects");
  //     if (data?.success) {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://api.arrowpublications.in/api/v1/product/update-product/${id}`,
        productData
      );
    ...
    try {
      ...
      if (willDelete) {
        const { data } = await axios.delete(
          `https://api.arrowpublications.in/api/v1/product/delete-product/${id}`
        );
        navigate("/dashboard/admin/products");
      } else {
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`https://api.arrowpublications.in/api/v1/product/product-photo/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
              ...
              <div className="mb-3">
                {frontphoto ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`https://api.arrowpublications.in/api/v1/product/product-frontphoto/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
              ...
              <div className="mb-3">
                {backphoto ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`https://api.arrowpublications.in/api/v1/product/product-backphoto/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
              ...
              <div className="mb-3">
                ...
                />
                <div className="mb-3">
                  <label htmlFor="fname">Shipping Price</label>
                  <input
                    type="number"
                    value={shippingPrice}
