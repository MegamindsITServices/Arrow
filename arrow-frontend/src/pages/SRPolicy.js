      ...
      <div>
        <section className="px-5">
          ...
          <div className="my-5 ">
            ...
            <p>
              In case the party returns the ordered item we will return the cost
              of the BOOKS amount only within 7 working days subject to the bank
              details mentioned by the party.
              ...
              <p>
                {" "}
                Book with obvious signs of use CD, DVD, VHS tape, software,
