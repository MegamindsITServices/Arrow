    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://api.arrowpublications.in/api/v1/posts/get-all-posts"
        );
                    ...
                    <Carousel>
                      <Carousel.Item>
                        <img
                          ...
                          src={`https://api.arrowpublications.in/api/v1/posts/get-photo/${post.slug}`}
                          alt="First slide"
                          height={"200px"}
                        />
                      </Carousel.Item>
                      <Carousel.Item>
                        <img
                          className="d-block carouse-img-arrow"
                          src={`https://api.arrowpublications.in/api/v1/posts/get-secondphoto/${post.slug}`}
                          alt="Second slide"
                        />
                      </Carousel.Item>
                      <Carousel.Item>
                        <img
                          className="d-block carouse-img-arrow"
                          src={`https://api.arrowpublications.in/api/v1/posts/get-thirdphoto/${post.slug}`}
                          alt="Third slide"
                        />
                      </Carousel.Item>
                    </Carousel>
